...
#define nrn_init _nrn_init__MF_Input
#define _nrn_initial _nrn_initial__MF_Input
#define nrn_cur _nrn_cur__MF_Input
#define _nrn_current _nrn_current__MF_Input
#define nrn_jacob _nrn_jacob__MF_Input
#define nrn_state _nrn_state__MF_Input
#define _net_receive _net_receive__MF_Input 
#define rates rates__MF_Input 
#define states states__MF_Input 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 MF_Input D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Scripts/Tuning/MF_Input.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=MF_Input type=spikeGenerator)";
