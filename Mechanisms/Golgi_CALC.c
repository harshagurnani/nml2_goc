...
#define _gth 0
#define iCa_Golgi_CALC _thread1data[0]
#define iCa _thread[_gth]._pval[0]
...
#define surfaceArea_Golgi_CALC _thread1data[1]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "area");
 	...
 	ivoc_help("help ?1 Golgi_CALC D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Mechanisms/Golgi_CALC.mod\n");
