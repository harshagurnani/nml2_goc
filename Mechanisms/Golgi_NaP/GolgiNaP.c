...
extern Memb_func* memb_func;
 ...
 "gmax_GolgiNaP", "S/cm2",
 "conductance_GolgiNaP", "uS",
 "m_forwardRate_rate_GolgiNaP", "kHz",
 "m_forwardRate_midpoint_GolgiNaP", "mV",
 "m_forwardRate_scale_GolgiNaP", "mV",
 "m_reverseRate_rate_GolgiNaP", "kHz",
 "m_reverseRate_midpoint_GolgiNaP", "mV",
 "m_reverseRate_scale_GolgiNaP", "mV",
 "m_steadyState_midpoint_GolgiNaP", "mV",
 "m_steadyState_scale_GolgiNaP", "mV",
 "m_q10Settings_experimentalTemp_GolgiNaP", "K",
 "m_q10Settings_TENDEGREES_GolgiNaP", "K",
 "gion_GolgiNaP", "S/cm2",
 "m_forwardRate_r_GolgiNaP", "kHz",
 "m_reverseRate_r_GolgiNaP", "kHz",
 "m_alpha_GolgiNaP", "kHz",
 "m_beta_GolgiNaP", "kHz",
 "m_tau_GolgiNaP", "ms",
 "g_GolgiNaP", "uS",
 0,0
...
"GolgiNaP",
 "gmax_GolgiNaP",
 "conductance_GolgiNaP",
 "m_instances_GolgiNaP",
 "m_forwardRate_rate_GolgiNaP",
 "m_forwardRate_midpoint_GolgiNaP",
 "m_forwardRate_scale_GolgiNaP",
 "m_reverseRate_rate_GolgiNaP",
 "m_reverseRate_midpoint_GolgiNaP",
 "m_reverseRate_scale_GolgiNaP",
 "m_steadyState_rate_GolgiNaP",
 "m_steadyState_midpoint_GolgiNaP",
 "m_steadyState_scale_GolgiNaP",
 "m_q10Settings_q10Factor_GolgiNaP",
 "m_q10Settings_experimentalTemp_GolgiNaP",
 "m_q10Settings_TENDEGREES_GolgiNaP",
 0,
 "gion_GolgiNaP",
 "m_forwardRate_x_GolgiNaP",
 "m_forwardRate_r_GolgiNaP",
 "m_reverseRate_x_GolgiNaP",
 "m_reverseRate_r_GolgiNaP",
 "m_steadyState_x_GolgiNaP",
 "m_q10Settings_q10_GolgiNaP",
 "m_rateScale_GolgiNaP",
 "m_alpha_GolgiNaP",
 "m_beta_GolgiNaP",
 "m_fcond_GolgiNaP",
 "m_inf_GolgiNaP",
 "m_tau_GolgiNaP",
 "conductanceScale_GolgiNaP",
 "fopen0_GolgiNaP",
 "fopen_GolgiNaP",
 "g_GolgiNaP",
 0,
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	conductance = 1e-005;
 	m_instances = 1;
 	m_forwardRate_rate = 0.91;
 	m_forwardRate_midpoint = -40;
 	m_forwardRate_scale = 5;
 	m_reverseRate_rate = 0.62;
 	m_reverseRate_midpoint = -40;
 	m_reverseRate_scale = -5;
 	m_steadyState_rate = 1;
 	m_steadyState_midpoint = -43;
 	m_steadyState_scale = 5;
 	m_q10Settings_q10Factor = 3;
 	m_q10Settings_experimentalTemp = 303.15;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiNaP D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Mechanisms/Golgi_NaP/GolgiNaP.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=GolgiNaP type=ionChannelHH)";
