...
#define nrn_init _nrn_init__GolgiKV
#define _nrn_initial _nrn_initial__GolgiKV
#define nrn_cur _nrn_cur__GolgiKV
#define _nrn_current _nrn_current__GolgiKV
#define nrn_jacob _nrn_jacob__GolgiKV
#define nrn_state _nrn_state__GolgiKV
#define _net_receive _net_receive__GolgiKV 
#define rates rates__GolgiKV 
#define states states__GolgiKV 
...
#define gion _p[12]
#define n_forwardRate_x _p[13]
#define n_forwardRate_r _p[14]
#define n_reverseRate_r _p[15]
...
#define g _p[26]
#define n_q _p[27]
#define temperature _p[28]
#define ek _p[29]
#define ik _p[30]
#define rate_n_q _p[31]
#define Dn_q _p[32]
#define v _p[33]
#define _g _p[34]
...
extern Memb_func* memb_func;
 ...
 "setdata_GolgiKV", _hoc_setdata,
 "rates_GolgiKV", _hoc_rates,
 0, 0
};
 ...
 "gmax_GolgiKV", "S/cm2",
 "conductance_GolgiKV", "uS",
 "n_forwardRate_rate_GolgiKV", "kHz",
 "n_forwardRate_midpoint_GolgiKV", "mV",
 "n_forwardRate_scale_GolgiKV", "mV",
 "n_reverseRate_rate_GolgiKV", "kHz",
 "n_reverseRate_midpoint_GolgiKV", "mV",
 "n_reverseRate_scale_GolgiKV", "mV",
 "n_q10Settings_experimentalTemp_GolgiKV", "K",
 "n_q10Settings_TENDEGREES_GolgiKV", "K",
 "gion_GolgiKV", "S/cm2",
 "n_forwardRate_r_GolgiKV", "kHz",
 "n_reverseRate_r_GolgiKV", "kHz",
 "n_alpha_GolgiKV", "kHz",
 "n_beta_GolgiKV", "kHz",
 "n_tau_GolgiKV", "ms",
 "g_GolgiKV", "uS",
...
"GolgiKV",
 ...
 "conductance_GolgiKV",
 "n_instances_GolgiKV",
 "n_forwardRate_rate_GolgiKV",
 "n_forwardRate_midpoint_GolgiKV",
 "n_forwardRate_scale_GolgiKV",
 "n_reverseRate_rate_GolgiKV",
 "n_reverseRate_midpoint_GolgiKV",
 "n_reverseRate_scale_GolgiKV",
 "n_q10Settings_q10Factor_GolgiKV",
 "n_q10Settings_experimentalTemp_GolgiKV",
 "n_q10Settings_TENDEGREES_GolgiKV",
 0,
 "gion_GolgiKV",
 "n_forwardRate_x_GolgiKV",
 "n_forwardRate_r_GolgiKV",
 "n_reverseRate_r_GolgiKV",
 "n_q10Settings_q10_GolgiKV",
 "n_rateScale_GolgiKV",
 "n_alpha_GolgiKV",
 "n_beta_GolgiKV",
 "n_fcond_GolgiKV",
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiKV D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Mechanisms/Golgi_KV/GolgiKV.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "Mod file for component: Component(id=GolgiKV type=ionChannelHH)";
