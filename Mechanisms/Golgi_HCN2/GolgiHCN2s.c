...
#define s_timeCourse_t2 _p[8]
#define s_timeCourse_t _p[9]
#define s_steadyState_V _p[10]
#define s_steadyState_rvi _p[11]
#define s_steadyState_x _p[12]
#define s_rateScale _p[13]
#define s_fcond _p[14]
#define s_inf _p[15]
#define s_tauUnscaled _p[16]
#define s_tau _p[17]
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiHCN2s D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Mechanisms/Golgi_HCN2/GolgiHCN2s.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   s_timeCourse_t2 = exp ( ( 0.0152 * s_timeCourse_V ) + 5.2944 ) * 2.3026 ;
   if ( s_timeCourse_V > - 20.0 ) {
     s_timeCourse_t = 500.0 * s_timeCourse_TIME_SCALE ;
     }
   else {
