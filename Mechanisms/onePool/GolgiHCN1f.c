...
#define f_q10Settings_q10Factor _p[6]
#define f_q10Settings_experimentalTemp _p[7]
#define f_q10Settings_TENDEGREES _p[8]
#define gion _p[9]
#define f_timeCourse_V _p[10]
#define f_timeCourse_t2 _p[11]
#define f_timeCourse_t _p[12]
#define f_steadyState_V _p[13]
#define f_steadyState_x _p[14]
#define f_q10Settings_q10 _p[15]
#define f_rateScale _p[16]
#define f_fcond _p[17]
#define f_inf _p[18]
#define f_tauUnscaled _p[19]
#define f_tau _p[20]
...
extern Memb_func* memb_func;
 ...
 "f_q10Settings_experimentalTemp_GolgiHCN1f", "K",
 "f_q10Settings_TENDEGREES_GolgiHCN1f", "K",
...
"GolgiHCN1f",
 ...
 "f_q10Settings_q10Factor_GolgiHCN1f",
 "f_q10Settings_experimentalTemp_GolgiHCN1f",
 "f_q10Settings_TENDEGREES_GolgiHCN1f",
 0,
 "gion_GolgiHCN1f",
...
static void nrn_alloc(Prop* _prop) {
	...
	double *_p; Datum *_ppvar;
 	...
 	f_q10Settings_experimentalTemp = 306.15;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiHCN1f D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Mechanisms/onePool/GolgiHCN1f.mod\n");
...
static int  rates ( _threadargsproto_ ) {
   ...
   if ( f_timeCourse_t2 > ( 200.0 ) ) {
     f_timeCourse_t = 200.0 * f_timeCourse_TIME_SCALE ;
     }
   else if ( f_timeCourse_t2 < ( 0.1 ) ) {
