...
extern Memb_func* memb_func;
 ...
 "alp_n_GolgiKM", _hoc_alp_n,
 "bet_n_GolgiKM", _hoc_bet_n,
 "rate_GolgiKM", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GolgiKM
#define bet_n bet_n_GolgiKM
 extern double alp_n( _threadargsprotocomma_ double );
 extern double bet_n( _threadargsprotocomma_ double );
 #define _zdelta _thread[4]._pval[0]
 #define _zq10 _thread[4]._pval[1]
 /* declare global and static user variables */
#define Abeta_n Abeta_n_GolgiKM
 double Abeta_n = 0.0033;
#define Aalpha_n Aalpha_n_GolgiKM
 double Aalpha_n = 0.0033;
#define B_ninf B_ninf_GolgiKM
 double B_ninf = 6;
#define Kbeta_n Kbeta_n_GolgiKM
 double Kbeta_n = -20;
#define Kalpha_n Kalpha_n_GolgiKM
 double Kalpha_n = 40;
#define Q10 Q10_GolgiKM
 double Q10 = 3;
#define V0beta_n V0beta_n_GolgiKM
 double V0beta_n = -30;
#define V0alpha_n V0alpha_n_GolgiKM
 double V0alpha_n = -30;
 ...
 "Aalpha_n_GolgiKM", &Aalpha_n_GolgiKM,
 "Kalpha_n_GolgiKM", &Kalpha_n_GolgiKM,
 "V0alpha_n_GolgiKM", &V0alpha_n_GolgiKM,
 "Abeta_n_GolgiKM", &Abeta_n_GolgiKM,
 "Kbeta_n_GolgiKM", &Kbeta_n_GolgiKM,
 "V0beta_n_GolgiKM", &V0beta_n_GolgiKM,
 "B_ninf_GolgiKM", &B_ninf_GolgiKM,
 "Q10_GolgiKM", &Q10_GolgiKM,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiKM D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_KM.mod\n");
...
static int  rate ( _threadargsprotocomma_ double _lv ) {
 ...
 _la_n = alp_n ( _threadargscomma_ _lv ) ;
   ...
   tcorr = pow( Q10 , ( ( celsius - 22.0 ) / 10.0 ) ) ;
