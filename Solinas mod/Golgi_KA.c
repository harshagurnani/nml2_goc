...
#define _f_rate _f_rate__GolgiKA 
#define rate rate__GolgiKA 
...
#define Da _p[11]
#define Db _p[12]
#define alpha_a _p[13]
#define beta_a _p[14]
#define alpha_b _p[15]
#define beta_b _p[16]
#define v _p[17]
#define _g _p[18]
...
extern Memb_func* memb_func;
 ...
 "alp_b_GolgiKA", _hoc_alp_b,
 "alp_a_GolgiKA", _hoc_alp_a,
 "bet_b_GolgiKA", _hoc_bet_b,
 "bet_a_GolgiKA", _hoc_bet_a,
 "linoid_GolgiKA", _hoc_linoid,
 "rate_GolgiKA", _hoc_rate,
 "sigm_GolgiKA", _hoc_sigm,
 0, 0
};
#define alp_b alp_b_GolgiKA
#define alp_a alp_a_GolgiKA
#define bet_b bet_b_GolgiKA
#define bet_a bet_a_GolgiKA
#define linoid linoid_GolgiKA
#define sigm sigm_GolgiKA
...
#define Abeta_b Abeta_b_GolgiKA
 double Abeta_b = 0.0345;
#define Aalpha_b Aalpha_b_GolgiKA
 double Aalpha_b = 0.0368;
#define Abeta_a Abeta_a_GolgiKA
 double Abeta_a = 0.1655;
#define Aalpha_a Aalpha_a_GolgiKA
 double Aalpha_a = 0.8147;
#define K_binf K_binf_GolgiKA
 double K_binf = 8.4;
#define K_ainf K_ainf_GolgiKA
 double K_ainf = -17;
#define Kbeta_b Kbeta_b_GolgiKA
 double Kbeta_b = -8.90123;
#define Kalpha_b Kalpha_b_GolgiKA
 double Kalpha_b = 12.8433;
#define Kbeta_a Kbeta_a_GolgiKA
 double Kbeta_a = 19.4718;
#define Kalpha_a Kalpha_a_GolgiKA
 double Kalpha_a = -23.3271;
#define Q10 Q10_GolgiKA
 double Q10 = 3;
#define V0_binf V0_binf_GolgiKA
 double V0_binf = -78.8;
#define V0_ainf V0_ainf_GolgiKA
 double V0_ainf = -38;
#define V0beta_b V0beta_b_GolgiKA
 double V0beta_b = -49.9537;
#define V0alpha_b V0alpha_b_GolgiKA
 double V0alpha_b = -111.332;
#define V0beta_a V0beta_a_GolgiKA
 double V0beta_a = -18.2791;
#define V0alpha_a V0alpha_a_GolgiKA
 double V0alpha_a = -9.17203;
#define usetable usetable_GolgiKA
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_GolgiKA", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_a_GolgiKA", "/ms",
 "Kalpha_a_GolgiKA", "mV",
 "V0alpha_a_GolgiKA", "mV",
 "Abeta_a_GolgiKA", "/ms",
 "Kbeta_a_GolgiKA", "mV",
 "V0beta_a_GolgiKA", "mV",
 "Aalpha_b_GolgiKA", "/ms",
 "Kalpha_b_GolgiKA", "mV",
 "V0alpha_b_GolgiKA", "mV",
 "Abeta_b_GolgiKA", "/ms",
 "Kbeta_b_GolgiKA", "mV",
 "V0beta_b_GolgiKA", "mV",
 "V0_ainf_GolgiKA", "mV",
 ...
 "Aalpha_a_GolgiKA", &Aalpha_a_GolgiKA,
 "Kalpha_a_GolgiKA", &Kalpha_a_GolgiKA,
 "V0alpha_a_GolgiKA", &V0alpha_a_GolgiKA,
 "Abeta_a_GolgiKA", &Abeta_a_GolgiKA,
 "Kbeta_a_GolgiKA", &Kbeta_a_GolgiKA,
 "V0beta_a_GolgiKA", &V0beta_a_GolgiKA,
 "Aalpha_b_GolgiKA", &Aalpha_b_GolgiKA,
 "Kalpha_b_GolgiKA", &Kalpha_b_GolgiKA,
 "V0alpha_b_GolgiKA", &V0alpha_b_GolgiKA,
 "Abeta_b_GolgiKA", &Abeta_b_GolgiKA,
 "Kbeta_b_GolgiKA", &Kbeta_b_GolgiKA,
 "V0beta_b_GolgiKA", &V0beta_b_GolgiKA,
 "V0_ainf_GolgiKA", &V0_ainf_GolgiKA,
 "K_ainf_GolgiKA", &K_ainf_GolgiKA,
 "V0_binf_GolgiKA", &V0_binf_GolgiKA,
 "K_binf_GolgiKA", &K_binf_GolgiKA,
 "Q10_GolgiKA", &Q10_GolgiKA,
 "usetable_GolgiKA", &usetable_GolgiKA,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiKA D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_KA.mod\n");
...
double alp_a ( _threadargsprotocomma_ double _lv ) {
   double _lalp_a;
 tcorr = pow( Q10 , ( ( celsius - 25.5 ) / 10.0 ) ) ;
...
_check_rate(_p, _ppvar, _thread, _nt);
 ...
 return; }
 if (_xi >= 20000.) {
 a_inf = _t_a_inf[20000];
 tau_a = _t_tau_a[20000];
 b_inf = _t_b_inf[20000];
 tau_b = _t_tau_b[20000];
 return; }
 _i = (int) _xi;
...
static void _initlists(){
 ...
 _slist2[0] = &(a) - _p;
 _slist2[1] = &(b) - _p;
   _t_a_inf = makevector(20001*sizeof(double));
   _t_tau_a = makevector(20001*sizeof(double));
   _t_b_inf = makevector(20001*sizeof(double));
   _t_tau_b = makevector(20001*sizeof(double));
_first = 0;
}
