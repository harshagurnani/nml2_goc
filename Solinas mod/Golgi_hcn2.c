...
#define usetable usetable_Golgi_hcn2
 ...
 "q_10_Golgi_hcn2", &q_10_Golgi_hcn2,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 Golgi_hcn2 D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_hcn2.mod\n");
...
static int _reset;
static char *modelname = "Cerebellum Golgi Cell HCN2 Model";
...
double tau_fast ( _threadargsprotocomma_ double _lpotential , double _lt1 , double _lt2 , double _lt3 ) {
   double _ltau_fast;
  _ltau_fast = exp ( _lt3 * ( ( _lt1 * _lpotential ) - _lt2 ) ) ;
...
double tau_slow ( _threadargsprotocomma_ double _lpotential , double _lt1 , double _lt2 , double _lt3 ) {
   double _ltau_slow;
  _ltau_slow = exp ( _lt3 * ( ( _lt1 * _lpotential ) - _lt2 ) ) ;
