...
extern Memb_func* memb_func;
 ...
 "d_Golgi_CALC2", "um",
 "ca2i0_Golgi_CALC2", "mM",
 "beta_Golgi_CALC2", "/ms",
 "ca2_pump_i_Golgi_CALC2", "mA",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 Golgi_CALC2 D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_CALC_ca2.mod\n");
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   ca2_pump_i = 2.0 * beta * ( ca2i - ca2i0 ) ;
   Dca2i = - ica2 / ( 2.0 * F * d ) * ( 1e4 ) - beta * ( ca2i - ca2i0 ) ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 ca2_pump_i = 2.0 * beta * ( ca2i - ca2i0 ) ;
 Dca2i = Dca2i  / (1. - dt*( ( - ( beta )*( ( 1.0 ) ) ) )) ;
  return 0;
}
 /*END CVODE*/
