...
extern Memb_func* memb_func;
 ...
 "alp_c_GolgiBK", _hoc_alp_c,
 "bet_c_GolgiBK", _hoc_bet_c,
 "rate_GolgiBK", _hoc_rate,
 0, 0
};
#define alp_c alp_c_GolgiBK
#define bet_c bet_c_GolgiBK
 extern double alp_c( _threadargsprotocomma_ double );
 extern double bet_c( _threadargsprotocomma_ double );
 /* declare global and static user variables */
#define Q10 Q10_GolgiBK
 double Q10 = 3;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiBK D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_BK.mod\n");
