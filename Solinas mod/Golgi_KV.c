...
#define _f_rate _f_rate__GolgiKV 
#define rate rate__GolgiKV 
...
extern Memb_func* memb_func;
 ...
 "alp_n_GolgiKV", _hoc_alp_n,
 "bet_n_GolgiKV", _hoc_bet_n,
 "linoid_GolgiKV", _hoc_linoid,
 "rate_GolgiKV", _hoc_rate,
 0, 0
};
#define alp_n alp_n_GolgiKV
#define bet_n bet_n_GolgiKV
#define linoid linoid_GolgiKV
...
#define Abeta_n Abeta_n_GolgiKV
 double Abeta_n = 0.125;
#define Aalpha_n Aalpha_n_GolgiKV
 double Aalpha_n = -0.01;
#define Kbeta_n Kbeta_n_GolgiKV
 double Kbeta_n = -80;
#define Kalpha_n Kalpha_n_GolgiKV
 double Kalpha_n = -10;
#define Q10 Q10_GolgiKV
 double Q10 = 3;
#define V0beta_n V0beta_n_GolgiKV
 double V0beta_n = -36;
#define V0alpha_n V0alpha_n_GolgiKV
 double V0alpha_n = -26;
#define usetable usetable_GolgiKV
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_GolgiKV", 0, 1,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "Aalpha_n_GolgiKV", "/ms-mV",
 "Kalpha_n_GolgiKV", "mV",
 "V0alpha_n_GolgiKV", "mV",
 "Abeta_n_GolgiKV", "/ms",
 "Kbeta_n_GolgiKV", "mV",
 "V0beta_n_GolgiKV", "mV",
 "Q10_GolgiKV", "1",
 "gkbar_GolgiKV", "mho/cm2",
 "ik_GolgiKV", "mA/cm2",
 "tau_n_GolgiKV", "ms",
 "g_GolgiKV", "mho/cm2",
 "tcorr_GolgiKV", "1",
 ...
 "Aalpha_n_GolgiKV", &Aalpha_n_GolgiKV,
 "Kalpha_n_GolgiKV", &Kalpha_n_GolgiKV,
 "V0alpha_n_GolgiKV", &V0alpha_n_GolgiKV,
 "Abeta_n_GolgiKV", &Abeta_n_GolgiKV,
 "Kbeta_n_GolgiKV", &Kbeta_n_GolgiKV,
 "V0beta_n_GolgiKV", &V0beta_n_GolgiKV,
 "Q10_GolgiKV", &Q10_GolgiKV,
 "usetable_GolgiKV", &usetable_GolgiKV,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 GolgiKV D:/Work/Comp Models/Learn Neuroml2/nml2_goc/Golgi_KV.mod\n");
...
double alp_n ( _threadargsprotocomma_ double _lv ) {
   double _lalp_n;
 tcorr = pow( Q10 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
...
_check_rate(_p, _ppvar, _thread, _nt);
 ...
 return; }
 if (_xi >= 20000.) {
 n_inf = _t_n_inf[20000];
 tau_n = _t_tau_n[20000];
 return; }
 _i = (int) _xi;
...
static void _initlists(){
 ...
 _slist2[0] = &(n) - _p;
   _t_n_inf = makevector(20001*sizeof(double));
   _t_tau_n = makevector(20001*sizeof(double));
_first = 0;
}
